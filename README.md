...
This project is **based on the original OpenBRF source code**. The goal of this fork is to improve the workflow for working with Mount&Blade resources, particularly meshes and animations.
...
- Press `F3` to focus the search field.
...
Original OpenBRF was created by **Marco Tarini** and contributors.

This repository does not claim authorship of the original OpenBRF application. 
The changes in this fork are limited to the enhancements and fixes documented in this repository.


Suggestions, bug reports, testing, and improvements are welcome.
If you find a problem, please let me know


[OpenBRF]: https://github.com/Swyter/openbrf
