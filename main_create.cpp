...
*/
    ...
    lang -> addAction( optionLanguage[3] = new QAction(QString::fromLatin1("Espaol"),this) );
	lang -> addSeparator();
...
void MainWindow::createConnections(){
	...
	connect( selector, SIGNAL(breakAniMany(std::vector<int>,bool)),
	         this, SLOT(breakAniMany(std::vector<int>,bool)));
